...
ingredientes:
  - ingrediente: lentejas
    ...
    nota: Peso seco de referencia; cantidad habitual pendiente de confirmar.
  ...
  - ingrediente: pimiento
    ...
    unidad: unidad
    referencia_peso: crudo
    nota: Color sin especificar en la fuente.
  - ingrediente: cebolla
    cantidad: 100
    unidad: g
    referencia_peso: crudo
  ...
  - ingrediente: agua
    ...
    unidad: ml
    referencia_peso: no_aplica
    nota: Cantidad habitual de cocción confirmada para la versión más caldosa. El agua de remojo va aparte. No es artículo de compra.
  - ingrediente: concentrado de verduras
    cantidad: 35
    unidad: g
    referencia_peso: no_aplica
...
Rendimiento doméstico pendiente. El remojo requiere previsión aparte del trabajo activo. Concretar el tiempo total y la cantidad que se reserva para otra comida al fijar la tanda habitual.
...
Pendientes: rendimiento para cena y táperes, formato para llevar y organización de remojo, conservación y recalentado.

## Al cambiar las cantidades

Revisar la capacidad del vaso antes de aumentar sólidos o líquido. Los tiempos no se escalan automáticamente con las raciones.

## Datos pendientes

- Tanda habitual de lentejas: la ficha mantiene 350 g secos de referencia, pendientes de confirmación.
- Otros ajustes de ingredientes, variedad de lenteja y formato de concentrado.
- Rendimiento y tiempos habituales.
